...
![](../../assets/monolith_2.png)

{/*
import Image from 'next/image'
import monolithDark from "../../assets/monolith_2.png"
import monolithLight from "../../assets/monolith_2_light.png"
...
An additional benefit is that requests can be handled more quickly and reliably when they do not require calls to out-of-process components.
