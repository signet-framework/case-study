...
In the context of contract test, services are classified as either a provider or consumer.
...
In practice, a single service can act as either a provider or a consumer in different situations (but ideally not with respect to the same other service).
