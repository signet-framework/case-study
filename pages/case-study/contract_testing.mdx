...
![Integration test vs service test vs contract test](./assets/images/2023-08-07-12-48-29.png)
...
As mentioned, contract tests do not eliminate the need for integration and E2E tests.
