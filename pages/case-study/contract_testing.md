...
Integration and E2E test provide a lot of confidence because they try to re-create production conditions as accurately as possible.
...
The other key differentiator between methodologies is how they the contract is generated.
In other words, who is the source of truth? Does the contract originate from how one of the services is implemented, or is it generated separately? Existing solutions generally fall into one of three categories.
...
As far as contract tests go, this methodology yields the most confidence that the services integrate correctly.
...
Only when the consumer team is notified of a successful test are they able to proceed to deploying the new version of the consumer.
...
Taking into account that microservices often have multiple external dependencies, performing consumer-driven contract testing requires coordination from multiple teams any time a service is updated.
...
Specmatic is another SaaS offering for spec-driven contract testing.
